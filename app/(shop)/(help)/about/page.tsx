          ...
          <div className="relative rounded-[3.5rem] overflow-hidden bg-primary p-8 md:p-20 text-primary-foreground mb-20 shadow-2xl shadow-primary/20 group">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-8">
                Precision in <br />
                <span className="text-primary-foreground/80 underline decoration-primary-foreground/30 underline-offset-8">
                  Technology
                </span>
              </h1>
              <p className="text-xl md:text-2xl font-medium leading-relaxed opacity-90 max-w-2xl">
                Adriatek Limited is a specialized technical distribution agency,
                bridging the gap between futuristic innovation and European
                logistical demands.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
            <div className="lg:col-span-5">
              <div className="sticky top-24">
                ...
                <p className="text-lg text-muted-foreground font-medium leading-relaxed mb-8">
                  Based in the technical hub of Hong Kong with a strategic
                  European focus, we curate an exclusive portfolio of
                  high-performance electronics designed for the next generation
                  of professional and domestic environments.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted/30 border border-primary/5">
                    ...
                    <span className="font-bold tracking-tight">
                      Verified Technical Authenticity
                    </span>
                  </div>
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted/30 border border-primary/5">
                    <div className="size-10 rounded-xl bg-primary/10 flex items-center justify-center">
            ...
            <div className="lg:col-span-7 space-y-12">
              <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground font-medium italic">
                ...
                tailored solutions, supported by professional consultation,
                precise logistics, and consistent after-sales support."
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {values.map((value, idx) => (
                  <div
                    key={idx}
                    className="p-8 rounded-[2.5rem] bg-background border border-primary/10 shadow-xl shadow-primary/5 group hover:-translate-y-2 transition-transform"
                  >
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {advantages.map((advantage, index) => (
                <div
                  key={index}
                  className="flex flex-col p-10 rounded-[3rem] bg-muted/20 border border-primary/5 relative group h-full"
                >
                  <div className="absolute top-10 right-10 text-6xl font-black opacity-5 group-hover:opacity-20 transition-opacity">
                    0{index + 1}
                  </div>
                  ...
                  <h3 className="text-xl font-black mb-4 uppercase tracking-tighter z-10">
                    {advantage.title}
                  </h3>
          ...
          <div className="p-12 md:p-24 rounded-[4rem] bg-muted/40 border border-primary/10 relative overflow-hidden text-center">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground font-medium mb-12 leading-relaxed">
                Join the network of tech-enabled households and corporate
                infrastructures powered by Adriatek Limited.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="h-16 px-12 text-lg font-black rounded-2xl shadow-2xl shadow-primary/20 transition-all hover:scale-105"
                >
                  <Link href="/catalogue">
                ...
                <Button
                  ...
                  size="lg"
                  asChild
                  className="h-16 px-12 text-lg font-black rounded-2xl border-primary/10 bg-background/50 hover:bg-background transition-all"
                >
                  <Link href="/contacts">
...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the mission, values, and technical expertise of Adriatek Limited, your premium electronics distributor in Europe.",
};

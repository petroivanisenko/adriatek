            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <section id="payment">
                ...
                <Alert className="mb-8 border-primary bg-primary/5 rounded-[2rem] p-8 border-2">
                  ...
                  <AlertTitle className="text-2xl font-black mb-2 uppercase tracking-tight">
                    SEPA Exclusive Protocol
                  </AlertTitle>
                  <AlertDescription className="text-lg font-medium leading-relaxed opacity-80">
                    Adriatek Limited operates exclusively via SEPA (Single Euro
                    Payments Area) bank transfers. This ensures technical
                    traceability and regulatory compliance for premium
                  ...
                  <div className="p-8 rounded-[2.5rem] bg-muted/30 border border-primary/5">
                    ...
                    <ul className="space-y-4">
                      {[
                        ...
                        <li
                          key={idx}
                          className="flex gap-3 text-sm font-bold opacity-70"
                        >
                  ...
                  <div className="p-8 rounded-[2.5rem] bg-destructive/5 border border-destructive/20">
                    ...
                    <ul className="space-y-4 text-xs font-black uppercase tracking-widest opacity-60">
                      <li className="flex items-center gap-3">
                        <span>❌</span> No Cards / Wallets
                      </li>
                      <li className="flex items-center gap-3">
                        <span>❌</span> No Cryptocurrency
                      </li>
                      <li className="flex items-center gap-3">
                        <span>❌</span> No Cash Payments
                      </li>
                      <li className="flex items-center gap-3">
                        <span>❌</span> No COD Operations
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    {[
                      {
                        ...
                        desc: "Select components and initiate checkout process.",
                      },
                      {
                        step: "02",
                        title: "Invoice Dispatched",
                        desc: "Receive a formal electronic invoice with technical bank details.",
                      },
                      {
                        step: "03",
                        title: "SEPA Execution",
                        desc: "Release funds via an authorized European banking portal (5-day window).",
                      },
                      {
                        step: "04",
                        title: "Settlement Verified",
                        desc: "Automated verification within 24-48 corporate hours.",
                      },
                      {
                        step: "05",
                        title: "Logistic Launch",
                        desc: "Direct supplier notification and unit allocation.",
                      },
                    ].map((phase, idx) => (
                      <div key={idx} className="flex gap-6 items-start group">
                        <span className="text-sm font-black text-primary bg-primary/10 size-10 flex items-center justify-center rounded-xl shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                          {phase.step}
                        </span>
                        <div>
              ...
              <section id="delivery">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm font-bold leading-relaxed">
                          EU-27, EFTA (CH, NO, IS, LI), United Kingdom (GB/NI).
                        </p>
                      </div>
                      <div className="space-y-2 text-muted-foreground">
                        ...
                        <p className="text-sm font-bold leading-relaxed">
                          Albania, Monaco, Montenegro, San Marino, Serbia,
                          Turkey, Vatican.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-[9px] font-black text-destructive uppercase tracking-widest border border-destructive/20 bg-destructive/5 p-3 rounded-xl italic">
                        ...
                        <span>
                          Strict Embargo: RU, BY, UA & Sanctioned Regions
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {deliveryZones.map((zone) => (
                    <div
                      key={zone.id}
                      className="p-8 rounded-[2.5rem] bg-background border border-primary/5 shadow-xl shadow-primary/5 group hover:border-primary/20 transition-all"
                    >
                      ...
                      <div className="space-y-1 mb-4">
                        ...
                        <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.1em]">
                          {zone.time}
                        </p>
                      </div>
                ...
                <div className="p-10 md:p-16 rounded-[4rem] bg-primary text-primary-foreground relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-lg opacity-80 font-medium mb-10 max-w-2xl leading-relaxed">
                      Every transaction with Adriatek Limited is fully
                      documented. Our logistics team provides a technical
                      tracking index once the unit clears the primary hub.
                    </p>
                    <ul className="space-y-4 mb-12">
                      {importantInfo.map((info, index) => (
                        <li
                          key={index}
                          className="flex gap-4 items-start text-sm font-bold"
                        >
            ...
            <div className="lg:col-span-4 sticky top-24 space-y-8">
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="pt-4">
                    <p className="text-[10px] leading-relaxed text-muted-foreground font-medium uppercase tracking-tight italic opacity-60">
                      "Adherence to European banking standards ensures your
                      high-tech allocation is processed with the highest degree
              ...
              <div className="p-8 rounded-[2.5rem] border border-primary/20 bg-primary/5 text-center">
                ...
                <p className="text-xs font-bold leading-relaxed opacity-60 mb-6">
                  Prices and delivery times are subject to dynamic logistics
                  index adjustments. Final terms will be reflected in your
                  corporate invoice.
                </p>
                <Link
                  href="/terms"
                  className="text-[10px] font-black uppercase tracking-widest underline decoration-primary/30 hover:text-primary transition-colors"
                >
...
export const metadata: Metadata = {
  ...
  description:
    "Official delivery and SEPA settlement protocols for Adriatek Limited. Verified European delivery within 30 days.",
};

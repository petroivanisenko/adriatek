...
const technicalBriefs = [
  {
    ...
    description:
      "Understanding the shift from IPS to QD-OLED for professional color grading and high-refresh workloads.",
  ...
  },
  {
    ...
    description:
      "How modern ARM and x86 architectures differ in sustained throughput for AI and heavy compile tasks.",
  ...
  },
  {
    ...
    description:
      "The engineering behind balanced audio paths and jitter-reducing clocks in professional DACs.",
    link: "/guides/audio",
    category: "Acoustics",
    ...
    <div className="col-span-1 md:col-span-2 lg:col-span-2 group relative bg-card rounded-4xl overflow-hidden border border-border flex flex-col md:flex-row shadow-2xl shadow-secondary/20">
      ...
      <div className="w-full md:w-72 bg-muted/50 backdrop-blur-sm border-l border-border p-8 flex flex-col justify-center">
        <div className="space-y-6">
          <p className="text-muted-foreground/60 text-xs font-bold uppercase tracking-widest border-b border-border pb-4">
            Key Metrics
          </p>
